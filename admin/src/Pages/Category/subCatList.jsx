          ...
          <Table stickyHeader aria-label="sticky table">
            ...
            <TableBody className="bg-white">
              <TableRow>
                ...
                <TableCell width={100}>
                  <div className="flex items-center gap-4 w-[80px]">
                    <div className="img w-full  rounded-md overflow-hidden group">
                      <Link to="/product/123" data-discover="true">
                        <img
                ...
                <TableCell width={50}>
                  <Chip label="Bear" color="primary" />
                  <Chip label="Doll" color="primary" />
                  <Chip label="ars" color="primary" />
                </TableCell>
                <TableCell width={100}>
            ...
            <TableBody className="bg-white">
              <TableRow>
                ...
                <TableCell width={50}>
                  <span className="inline-block p-1 px-2 bg-gray-200 rounded-md">
                    Toys
                  </span>
                </TableCell>
                <TableCell width={100}>
