      ...
      <div className="loginBox card w-[600px] h-[auto] pb-25 mx-auto mt-15 relative z-50">
        ...
        <div className="flex items-center justify-center w-full mt-5 gap-2">
          <Button
            ...
            loadingPosition="end"
            variant="outlined"
            className="!text-white !capitalize !bg-[rgba(0,0,0,0.3)]"
          >
            Sign Up with Google
          </Button>
          <Button
        ...
        <div className="w-full flex items-center justify-center gap-3 ">
          <span className="flex items-center w-[100px] h-[1px] !bg-[#000000]"></span>
          <span className="text-[15px] font-[700]  opacity-100">
        ...
        <form className="w-full px-8 mt-3">
          ...
          <div className="form-group mb-4 w-full">
            <h4 className="text-[14px] font-[500] mb-1">Phone Number</h4>
            <input
              type="tel"
              maxLength={10}
              onInput={(e) => {
